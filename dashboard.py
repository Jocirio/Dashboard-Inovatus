...
def load_data():
    ...
    # Cria as credenciais a partir do dict
    creds = service_account.Credentials.from_service_account_info(credentials_dict, scopes=SCOPES)

    # Conecta ao serviço Google Drive
    service = build('drive', 'v3', credentials=creds)

    # Obtém lista dos arquivos CSV na pasta do Drive
...
# Filtra dataframe conforme seleção do usuário
...
# Aqui segue a exibição dos dados e gráficos usando df_filtered
