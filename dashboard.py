...
# Grava o arquivo de credenciais gerado a partir do secreto do Streamlit
with open("credentials.json", "w") as f:
    f.write(st.secrets["gdrive_credentials"])

# Agora pode usar normalmente o arquivo credentials.json
