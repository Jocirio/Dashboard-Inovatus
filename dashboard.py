...
def load_data():
    # Carrega o JSON das credenciais do Streamlit Secrets
    ...
    # Conversão dos campos conforme necessidades
...
# Aqui você pode colocar seu código para apresentar as métricas e gráficos usando df_filtered
